...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnSave) {
            ...
            if (!myExternalFile.exists() ) {
                Toast.makeText(this, "ไม่มีไฟล์ "+FILENAME, Toast.LENGTH_SHORT).show();
                return;
            }
            readFile();
        }
    ...
    public void writeFile(String name,String score) {
        ...
        try {
            FileOutputStream fileOut = new FileOutputStream(myExternalFile) ; // open for new file
            //FileOutputStream fileOut = new FileOutputStream(myExternalFile, true) ;// Open for append
